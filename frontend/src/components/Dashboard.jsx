...
const Dashboard = ({ onLogout, userData }) => {
    ...
    const [userPreferences, setUserPreferences] = useState(userData?.preferences);
    const [hasFirstPurchase, setHasFirstPurchase] = useState(userData?.hasFirstPurchase || false);
    ...
    const handlePreferencesSave = async (preferences) => {
        try {
            ...
            const response = await axios.put(
                `${import.meta.env.VITE_API_URL}/api/auth/preferences/${userData._id}`,
                preferences
            );
